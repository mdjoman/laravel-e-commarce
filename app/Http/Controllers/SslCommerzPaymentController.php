...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       $billing = Billing::find($billing);
        ...
        $post_data['cus_name'] = $billing->lname;
        ...
        # OPTIONAL PARAMETERS
        $post_data['value_a'] =  Session::get('customar_id');
        $post_data['value_b'] =  Session::get('shiping_id');
        $post_data['value_c'] = Session::get('billing_id');
        $post_data['value_e'] =  date('Y-m-d');
        $post_data['value_f'] =  'online';
        ...
        $update_product = DB::table('orders')
            ...
            ->updateOrInsert([
                ...
                'customar_id' => $post_data['value_a'],
                'shiping_id' => $post_data['value_b'],
                'billing_id' => $post_data['value_c'],
                'payment_method' => $post_data['value_f'],
                'order_date' => $post_data['value_e'],
