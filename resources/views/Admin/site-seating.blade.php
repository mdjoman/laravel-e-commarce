...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Site Seationg</h1>
    <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Seationg</a>
  </div>
</div>
...
<div class="card card-body mb-5">
  <div class="container">
    ...
    <div class="container">
      ...
      <form class="" action="{{ route ('store-apparance')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="Categories Name" placeholder="Phone" value="{{$setting->phone}}" name="phone1">
            <span class="text-danger">{{ $errors->has('phone') ? $errors->first('phone') : ''}}</span>
          </div>
        </div>
        <div class="form-group row">
          <label class="col-sm-2 col-form-label" for="Categories Name">Phone1:</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="Categories Name" placeholder="Phone" value="{{$setting->phone2}}" name="phone2">
            <span class="text-danger">{{ $errors->has('phone') ? $errors->first('phone2') : ''}}</span>
          </div>
        </div>
        <div class="form-group row">
          <label class="col-sm-2 col-form-label" for="Categories Name">Sipping Cost(Dhaka):</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="Categories Name" placeholder="Phone" value="{{$setting->dhaka}}" required name="dhaka">
         
          </div>
        </div>
        <div class="form-group row">
          <label class="col-sm-2 col-form-label" for="Categories Name">Sipping Cost(Other):</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="Categories Name" placeholder="Phone" value="{{$setting->other}}" required name="other">
